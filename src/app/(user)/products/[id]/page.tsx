            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 ">
                ...
                <div className="lg:col-span-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <AccordionItem
                            title={<span className="font-[var(--font-inter-tight)] font-medium text-[20px] leading-[26px] tracking-[0.02em] text-[#191919] text-center lining-nums proportional-nums">About the product</span>}
                            defaultOpen={true}
                        >
                        ...
                        <AccordionItem title={<span className="font-[var(--font-inter-tight)] font-medium text-[20px] leading-[26px] tracking-[0.02em] text-[#191919] text-center lining-nums proportional-nums">
                            Ratings & Reviews
                        </span>}>
                            <div className="mt-4">
                                    ...
                                    <div className="space-y-6">
                                        {product.reviews && product.reviews.length > 0 ? (
                                            <>
                                                ...
                                                {product.reviews.length > 4 && !showAllReviews && (
                                                    <div className="pt-2">
                                                        <button
