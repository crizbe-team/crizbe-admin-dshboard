...
export default function NextFlavour() {
    ...
    return (
        <section className="min-h-screen flex justify-center items-center next-flavour-section relative overflow-visible py-20 pb-[100px] md:pt-[120px] md:pb-[100px] bg-transparent">
